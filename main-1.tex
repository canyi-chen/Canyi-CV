...
\section{\mysidestyle Personal Information}
    {\bf Canyi Chen (\begin{CJK*}{UTF8}{gbsn}陈灿贻\end{CJK*})} %\\
   % PhD \\
%\vspace{-8.5mm}
\vspace{-3mm}
...
\section{\mysidestyle Education}
    \textbf{Renmin University of China}, Beijing, China (September 2018 -- July 2023) \\
      \indent \hspace{5mm} PhD in {\it Statistics}

    \vspace{-2mm}
    \textbf{Beijing Normal University}, Beijing, China (September 2014 -- July 2018) \\
      \indent \hspace{5mm} BSc in {\it Mathematics and Applied Mathematics}
...
\section{\mysidestyle Research Interests}\vspace{1mm}	
    ...
    {\bf High-dimensional data analysis; Non-Linear dependence measure} 
    % \begin{description}
...
%\nocite{chen2022DistributedDecodingHeterogeneous,chen2022DistributedEstimationHeterogeneous,chen2024DistributedSparseComposite,zhang2022SlicedIndependenceTest,chen2022ScalableGloballyConvergent}
\printbibliography[heading=none]
\end{refsection}

\section{\mysidestyle Preprints}
\begin{refsection} % refsection environment
\nocite{chen2022RobustMultiTask,chen2022DistributedEstimationGap,chen2022DecentralizedDistributedEstimation,chen2022RobustFastLowRank,chen2022CommunicationEfficientDistributedSupportVectorMachine,chen2023Byzatine,hao2023ClassDirectedAcyclic,Al-Hinai2024VitaminD}
